...
// abiHelper.sol => contract Helper
var bytecode = '';
...
var factoryHelper = new ethers.ContractFactory(abi, bytecode, wallet);
...
var amounts = [];
var i = 0;
for (var account in tree.claims) {
    indexs[i] = tree.claims[account].index;
    accounts[i] = account;
    amounts[i] = ethers.BigNumber.from(tree.claims[account].amount);

    // console.log(amounts[i].toString());
    ++i;
}

const main = async (indexs, accounts, amounts) => {
    const helper = await factoryHelper.deploy();
    await helper.deployed();
    // let helper = new ethers.Contract('0x313f922be1649cec058ec0f076664500c78bdc0b', abi, provider);
    let data = await helper.helper(indexs, accounts, amounts);
    console.log(data.hashs);
    console.log(data.nodes);
}
main(indexs, accounts, amounts);

// https://lab.miguelmota.com/merkletreejs/example/

// Hash function : Keccak-256
// Options :  sortLeaves && sortPairs 
/*
[
  '0xa9e8f0fbf0d2911d746500a7786606d3fc80abb68a05f77fb730ded04a951c2d',
  '0xbeba51d0cb0bc6339edf1832ce33515c92b2bfdbf243e531188470ca084b3b2d',
